...
<body>
    <div class="form-container">
        ...
        <form id="donasiForm" action="proses_donasi.php" method="post" enctype="multipart/form-data">
    ...
    $(document).ready(function() {
        ...
        $("#donasiForm").on("submit", function(e) {
            ...
            // Tampilkan pop-up konfirmasi sebelum mengirimkan data
            if (confirm("Apakah Anda sudah yakin dengan data yang Anda masukkan?")) {
                ...
                this.submit();  // Mengirim form ke 'proses_donasi.php'

                updateDonasiList();
                clearForm();
            } else {
                // Jika user memilih "Cancel", kembali ke halaman index
